    ...
    >
      <div className="flex flex-col items-center gap-6 max-w-sm text-center">
        <div className="flex flex-col items-center gap-3">
          <div className="mb-2">
            <svg viewBox="0 0 127.14 96.36" xmlns="http://www.w3.org/2000/svg" className="w-16 h-16 text-[#5865F2]">
              <path d="M107.7,8.07A105.15,105.15,0,0,0,81.47,0a72.06,72.06,0,0,0-3.36,6.83A97.68,97.68,0,0,0,49,6.83,72.37,72.37,0,0,0,45.64,0,105.89,105.89,0,0,0,19.39,8.09C2.79,32.65-1.71,56.6.54,80.21h0A105.73,105.73,0,0,0,32.71,96.36,77.7,77.7,0,0,0,39.6,85.25a68.42,68.42,0,0,1-10.85-5.18c.91-.66,1.8-1.34,2.66-2a75.57,75.57,0,0,0,64.32,0c.87.71,1.76,1.39,2.66,2a68.68,68.68,0,0,1-10.87,5.19,77,77,0,0,0,6.89,11.1,105.25,105.25,0,0,0,32.19-16.14c2.64-27.38-4.51-51.11-19.32-72.1ZM42.63,65.22C36.14,65.22,30.8,59.3,30.8,52.05s5.15-13.17,11.83-13.17c6.74,0,12,5.92,11.83,13.17C54.46,59.3,49.27,65.22,42.63,65.22Zm41.88,0c-6.49,0-11.83-5.92-11.83-13.17s5.15-13.17,11.83-13.17c6.74,0,12,5.92,11.83,13.17C96.34,59.3,91.15,65.22,84.51,65.22Z" fill="currentColor"/>
            </svg>
          </div>
